...
<body>
    ...
    <div class="container">
        ...
        <h1 class="display-4 text-center">filtrer par service</h1>
        ...
        <form method="post" action="" class="row offset-md-5 mt-4">
            ...
            <div id="employes">
                ...
                echo '<select class="col-md-12" id="service" name="service">';
            ...
            <!-- <input type="submit" class="col-md-2 ml-2 btn btn-dark" id="submit" value="Chercher" placeholder="Prénom a insérer"> -->
        </form>
