...
<?php
    ...
    */
    ...
    echo $x, $y, '<br>'; //Dans l'instruction echo, on peut séparer les éléments affichés par une virgule. Cette syntaxe est spécifique au echo et ne marche pas avec print.
    ...
    $message = 'Aujourd\'hui'; // on échappe les apostrophes dans les quotes simples avec \ (alt gr + 8).

    $txt = 'Bonjour';

    echo "$txt tout le monde <br>";// Dans les guillemets, la variable est évalué : c'est son contenu qui est affiché 'ici bonjour).

    echo '$txt tout le monde <br>'; // Dans les quotes simples, la variable n'est pas évalué : elle est traitée comme du texte brute (affiche $txt). 
