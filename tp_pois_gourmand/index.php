            ...
            <div class="row">
                ...
                <div class="col-md-4 offset-md-1 formule">
                    ...
                    <p>Tomates buratina<br>
                        ...
                        Panna cotta</p>
                    <button type="button" class="col-md-12 btn btn-info">Choisir</button>
        ...
        <section id="addition">
            ...
            <div class="row">
                ...
                <div class="col-md-8 commande">
                    ...
                    <h5>Votre formule Rome arrive dans quelques instants...<i class="fas fa-kiwi-bird"></i></h5>
                    ...
                    <p class="total">- Votre facture sera de 25€</p>
